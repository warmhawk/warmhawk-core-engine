/**
 * JWT auth token sign/verify. Protects warmhawk-core-engine's own management routes (domains,
 * campaigns, leads admin actions) — a Tier 0 ("direct API endpoints, no web UI") customer
 * authenticates directly against this API, distinct from the licensed dashboard's separate
 * session/login model.
 */
